  ...
  <body bgcolor='black' style='margin:0' oncontextmenu='return false' onkeydown='return false'
    ...
    <script>
      async function init() {
        ...
        player.configure({
          drm: {
            clearKeys: {
              ...
              'c1c657aa160c5b328f1e76747534b913': '785e0773e9d534a00f4619315674ef7f'
            }
          }
        });
        ...
        try {
          await player.load('https://lbs-usp-dash-live.cmore.se/tvm-packager-prod/group3/60ae452e1522bdf301694494/manifest.mpd');
